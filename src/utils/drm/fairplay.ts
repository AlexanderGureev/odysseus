...
function requestLicense(licenseUrl: string) {
  return function getLicense(emeOptions: any, contentId: string, keyMessage: any, callback: any) {
    const handleLicenseLoadError = (ev: any) => callback(ev);
