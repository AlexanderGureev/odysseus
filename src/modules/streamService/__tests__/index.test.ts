...
describe('StreamService', () => {
  ...
  //   const streamService = StreamService(nodrm_streams[0], capabilities, [StreamProtocol.DASH]);
  //   expect(streamService.getStream()).toBe(nodrm_streams[0][1]);
  //   expect(streamService.getStream()).toBe(nodrm_streams[0][0]);
  //   expect(streamService.getStream()).toBe(null);
  // });
  ...
  //   const capabilities = ['hls', 'dash'];
  //   const streamService = StreamService(nodrm_streams[0], capabilities, [`${StreamProtocol.DASH}:${DRM_TYPE.WIDEVINE}`]);
  //   expect(streamService.getStream()).toBe(nodrm_streams[0][0]);
  //   expect(streamService.getStream()).toBe(nodrm_streams[0][1]);
  //   expect(streamService.getStream()).toBe(null);
  // });
  ...
  //   const streamService = StreamService(drm_streams[0], capabilities, [`${StreamProtocol.HLS}:${DRM_TYPE.FAIRPLAY}`]);
  //   expect(streamService.getStream()).toBe(drm_streams[0][3]);
  // });
});
